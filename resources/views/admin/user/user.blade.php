...
<script>
    $(document).ready(function(){
        ...
        $('.editButton').on('click', function(){
            ...
            $('#editForm .isKicker').val(user.isKicker ? user.isKicker : '');
            $('#editForm .isPunter').val(user.isPunter ? user.isPunter : '');
            $('#editForm .isLongSnapper').val(user.isLongSnapper ? user.isLongSnapper : '');
